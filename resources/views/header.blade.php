    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-8 py-4 sm:py-4">
        <div class="flex flex-wrap items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center ml-auto lg:ml-0 lg:order-2" id="mobile-menu-1">
                ...
                <button id="mobile-menu-toggle" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 border border-gray-300 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="mobile-menu-2" aria-expanded="false">
