<header class="header">
    <nav class="bg-white border-gray-200 px-4 lg:px-8 py-4 sm:py-4">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="{{route('inicio')}}" class="flex items-center">
                <img src="{{asset('images/logo.webp')}}" class="h-10 sm:h-13" alt="Elsvan Inmobiliaria" />
            </a>
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 text-lg ">
                    ...
                    <li>
                        <a href="{{route('contactanos')}}" class="block py-2 pr-4 pl-3 text-gray-700 hover:text-orange-500 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Contactanos</a>
                    </li>
                    <li>
