...
<footer class="bg-brown text-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-10 pt-12 pb-8">
      ...
      <div class="hidden sm:block">
        <!-- Métricas inferiores -->
        <div class=" flex flex-col sm:flex-row justify-center items-center gap-10 mt-4 lg:mt-6 lg:gap-16">
            <!-- 100% cumplimiento -->
            <div class="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
            <i class="la la-calendar text-orange text-7xl"></i>
            <div class="flex items-center gap-2 lg:gap-5">
                <span class="text-4xl sm:text-5xl lg:text-5xl font-bold leading-none">100%</span>
            ...
            <div>
                <span class="text-4xl sm:text-3xl lg:text-4xl font-bold leading-none">+{{$year_more}} años </span>
    ...
    <div class="bg-orange py-4 text-center text-white text-sm  px-4">
      Copyright © {{$year_now}} Designed & Developed by
